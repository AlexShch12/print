...
////////// igor
  wp_register_script( 'custom-js', get_template_directory_uri() . '/js/custom-js.js');  
...
* поддержка миниатюр
**/
/** add_theme_support('post-thumbnails');  - дублирует register_nav_menu - 26-06-2018
**/

/**
* разрешить установить кнопку в сайдбаре:  wpcf7 + Easy FancyBox
**/
// add_filter('widget_text', 'do_shortcode');

/**
* разрешить wpcf7 выполнение шорткода
**/
