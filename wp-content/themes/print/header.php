...
<div class="main">	
	...
	<div class="call_back"><a class="fancybox-inline" href="#form_pop_up" style='text-decoration: none;'>Заказать звонок</a></div>
...
<!-- 	<a href="#contact_form_pop" class="fancybox-inline">Contact Us</a>
	...
	<div style="display:none" class="fancybox-hidden">
	    <div id="contact_form_pop" class="hentry" style="width:460px;max-width:100%;">
	        [contact-form-7 id="53" title="Замовити послугу"]
	    </div>
	</div>
 -->
